...
console.log("Car 33 is" + inventory[33].car_make +inventory[33].car_model+ inventory[33].car_year);


// ==== Challenge 2 ====
// The dealer needs the information on the last car in their inventory.  What is the make and model of the last car in the inventory?  Log the make and model into the console.
let lastCar = 0;
console.log(lastCar+inventory[0].car_make+inventory[0].car_model);
